...
# Output files
out_file_pdf <- "Proteomic_Figs/ER_acute_pathway_heatmap_centered_sigOnly_allLists_clusteredWithinPathway_withContrastAnno.pdf"
out_file_svg <- "Proteomic_Figs/ER_acute_pathway_heatmap_centered_sigOnly_allLists_clusteredWithinPathway_withContrastAnno.svg"
out_file_csv <- "Proteomic_Figs/ER_acute_pathway_heatmap_input_table_sigOnly_allLists_clusteredWithinPathway_withContrastAnno.csv"
...
colors <- colorRampPalette(c("#002BFF", "#FFFFCC", "#FF2B00"))(length(breaks) - 1)
