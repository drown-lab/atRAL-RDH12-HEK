...
| `Proteomic_Rscripts/Figures/depracated/` | `deprecated` | Older proteomics figure and enrichment scripts were moved here after active manuscript figure scripts were separated. |
| `Proteomic_Rscripts/Figures/depracated/HeatMap_Fig4wFerrop_unknownversion.R` | `deprecated` | Filename marks it as an unknown version. Prefer `Proteomic_Rscripts/Figures/HeatMap_Fig4wFerrop.R` unless manuscript review says otherwise. |
