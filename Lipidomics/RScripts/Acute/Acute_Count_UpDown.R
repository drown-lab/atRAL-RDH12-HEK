...
# Output file
out_file <- "Lipidomics/Figures/Acute/stacked_DE_counts_by_contrast.svg"
...
count_sig_by_contrast <- function(df, contrast, padj_cutoff = 0.1, lfc_cutoff = log2(1.3)) {
...
ggsave(
  filename = "Lipidomics/Figures/Acute/stacked_DEP_counts_by_contrast.svg",
  plot = p,
  width = 8,
  height = 7
)