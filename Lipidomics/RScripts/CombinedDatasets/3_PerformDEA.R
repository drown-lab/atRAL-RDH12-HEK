# Inspect conditions
table(colData(data_combat)$condition)
colData(data_combat)$condition
...
data_diff <- test_diff(
  ...
  test = c(
    ...
    #Recovery vs Acute
    "RDH12._Veh_vs_RDH12_Veh",
    "RDH12._100_vs_RDH12_100",
    "RDH12._200_vs_RDH12_200"
...
plot_volcano(dea, contrast = "RDH12._Veh_vs_RDH12_Veh", label_size = 3, add_names = TRUE) +
  labs(title = " RDH12._Veh_vs_RDH12_Veh")


plot_volcano(dea, contrast = "RDH12._100_vs_RDH12_100", label_size = 3, add_names = TRUE) +
  labs(title = " RDH12._100_vs_RDH12_100")
plot_volcano(dea, contrast = "RDH12._200_vs_RDH12_200", label_size = 3, add_names = TRUE) +
  labs(title = " RDH12._200_vs_RDH12_200")
