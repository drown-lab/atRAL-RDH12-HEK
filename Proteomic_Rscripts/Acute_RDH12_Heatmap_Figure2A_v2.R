...
# Output files
out_file_pdf <- "Proteomic_Figs/acute_pathway_heatmap_centered_sigOnly_allLists_clusteredWithinPathway_withContrastAnno.pdf"
out_file_svg <- "Proteomic_Figs/acute_pathway_heatmap_centered_sigOnly_allLists_clusteredWithinPathway_withContrastAnno.svg"
out_file_csv <- "Proteomic_Figs/acute_pathway_heatmap_input_table_sigOnly_allLists_clusteredWithinPathway_withContrastAnno.csv"
