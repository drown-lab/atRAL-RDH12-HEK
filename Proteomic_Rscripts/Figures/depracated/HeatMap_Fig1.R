...
# Output files
out_file_pdf <- "Proteomic_Figs/enriched/Fig1acute_pathway_heatmap_centered_sigOnly_Lists_clusteredWithinPathway_wContrastAnno.pdf"
out_file_svg <- "Proteomic_Figs/enriched/Fig1acute_pathway_heatmap_centered_sigOnly_Lists_clusteredWithinPathway_wContrastAnno.svg"
out_file_csv <- "Proteomic_Figs/enriched/Fig1acute_pathway_heatmap_input_table_sigOnly_clusteredWithinPathway_wContrastAnno.csv"
...
Nglycan_prcrsr_biosynthsis <- c(
  "ALG3","DPAGT1","ALG1","ALG2","ALG11","ALG5","ALG8","ALG9","RFT1","DPM1", "RPN1", "RPN2", "STT3A", "STT3B", "UGGT1"
)
...
MetalIon_SLCtransporters<- c("SLC39A7","SLC39A1","SLC31A1","SLC9A6","SLC39A10","SLC9A1","SLC39A14","SLC30A5", "ORAI1", "SLC7A11")
...
# 101 break points gives 100 color bins
my_breaks <- seq(-max_abs, max_abs, length.out = 101)

# Blue -> white -> red, with white exactly at 0
