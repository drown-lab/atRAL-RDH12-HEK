...
out_file_pdf <- file.path(out_dir, "Ferroptosis_process_heatmap_RDH12_acute_recovery.pdf")
out_file_svg <- file.path(out_dir, "Ferroptosis_process_heatmap_RDH12_acute_recovery.svg")
out_file_png <- file.path(out_dir, "Ferroptosis_process_heatmap_RDH12_acute_recovery.png")
