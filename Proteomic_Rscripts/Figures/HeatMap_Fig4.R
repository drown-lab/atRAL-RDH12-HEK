...
out_file_pdf <- "Proteomic_Figs/enriched/Fig4_pathway_heatmap_centered_noSigAnno_WTfarRight.pdf"
out_file_svg <- "Proteomic_Figs/enriched/Fig4_pathway_heatmap_centered_noSigAnno_WTfarRight.svg"
out_file_csv <- "Proteomic_Figs/enriched/Fig4_pathway_heatmap_centered_noSigAnno_WTfarRight_input.csv"
...
pdf(out_file_pdf, width = 13, height = 11)
draw(
  ht,
  heatmap_legend_side = "right",
  annotation_legend_side = "right",
