...
| PANGEA exports and plots | `supplemental` | `Proteomic_Rscripts/Create_PANGEA_tables.R`; `Proteomic_Rscripts/Figures/Enrichment_dotPlot_Folder_mixparentandchildGOterms.R` | `Proteomic_output_txts/PANGEA_exports/`; `Proteomic_output_txts/PANGEA_results_pval0.01_FC2/`; `Proteomic_Figs/PANGEA_top_terms_plots/` | PANGEA enrichment tables and top-term plots. |
...
|----|----|----|----|----|
| Proteomics Figure 1 pathway heatmap | `main-text` | `Proteomic_Rscripts/Figures/HeatMap_Fig1_horizontal_maintext.R`; `Proteomic_Rscripts/Figures/HeatMap_Fig1.R` | `Proteomic_Figs/enriched/1_Maintext_version/Fig1_horizontal_maintext_heatmap_centered_sigOnly.pdf`; `Proteomic_Figs/enriched/1_Maintext_version/Fig1_horizontal_maintext_heatmap_centered_sigOnly.svg`; `Proteomic_Figs/enriched/1_Maintext_version/Fig1_horizontal_maintext_heatmap_input_table.csv` | Main-text pathway heatmap candidate. |
| Proteomics Figure 4A pathway heatmap | `main-text` | `Proteomic_Rscripts/Figures/HeatMap_Fig4.R`; `Proteomic_Rscripts/Figures/HeatMap_Fig4wFerrop.R` | `Proteomic_Figs/enriched/1_Maintext_version/Fig4a_pathway_heatmap_centered_noSigAnno_WTfarRight.pdf`; `Proteomic_Figs/enriched/1_Maintext_version/Fig4a_pathway_heatmap_centered_noSigAnno_WTfarRight.svg`; `Proteomic_Figs/enriched/1_Maintext_version/Fig4a_pathway_heatmap_centered_noSigAnno_WTfarRight_input.csv` | Main-text pathway heatmap candidate, with ferroptosis-oriented variant. |
...
| Proteomics volcano plots | `supplemental` | `Proteomic_Rscripts/Create_Volcanos_allContrasts_toDirctry.R`; `Proteomic_Rscripts/Create_Volcanos_wMissingess_allContrasts_toDirctry.R`; `Proteomic_Rscripts/Figures/VolcanoPlot_coloreGOgroups.R` | `Proteomic_Figs/VolcanoPlots/`; `Proteomic_output_txts/Volcanotable_v1.csv`; `Proteomic_output_txts/Volcanotable_v2.csv` | Root volcano plot folders were removed or reorganized in the working tree; use current folder contents and regenerate only if needed. |
...
-   `Proteomic_Rscripts/Figures/HeatMap_Fig4wFerrop_unknownversion.R` is
